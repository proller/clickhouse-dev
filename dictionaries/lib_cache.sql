...
select dictHas('lib_cache_test1', toUInt64(n)) from system.one array join range(18) as n;
select dictHas('lib_cache_test1', toUInt64(n)) from system.one array join range(1000) as n                                                                                                        
