...
./clickhouse-test --testname --binary ${CUR_DIR}/../build$BUILD_TYPE/dbms/programs/clickhouse --configclient ${CUR_DIR}/clickhouse-client.xml --configserver ${CUR_DIR}/config.xml $TEST_OPT $*
