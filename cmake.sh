...
cmake $CURDIR/.. -DCXX11_ABI= -DNO_WERROR=1 -DUSE_STATIC_LIBRARIES=0 -DSPLIT_SHARED_LIBRARIES=1 -DCMAKE_BUILD_TYPE=Debug -DSAN_DEBUG=1 $CMAKE_OS -DUSE_EMBEDDED_COMPILER=1 $*
